function distance_plots(data)
{
  ...
  plot_50(index, distances);
  plot_200(index, distances);
  plot_16000(index, distances);
}

function plot_50 (index, distances)
{
  var pwidth = 400;
  var pheight = 300;
...
function plot_200 (index, distances)
{
  var pwidth = 400;
  var pheight = 300;
...
function plot_16000 (index, distances)
{
  var pwidth = 400;
  var pheight = 300;
